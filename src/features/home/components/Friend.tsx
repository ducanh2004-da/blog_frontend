...
export default function Friend() {
  return (
    // keep it in grid flow: lg:col-span-3, don't use fixed
    <aside className="lg:col-span-3 order-2 lg:order-1">
      {/* sticky container so it sticks while scrolling, and z-index so dropdowns from other components can overlay correctly */}
